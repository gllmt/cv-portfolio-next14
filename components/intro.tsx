    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <span className="absolute bottom-0 right-0 text-3xl animate-[wiggle_1s_ease-in-out_infinite]">
              👋
            </span>
          </motion.span>
        </div>
      ...
      <motion.h1
        className="mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] text-balance sm:text-4xl"
